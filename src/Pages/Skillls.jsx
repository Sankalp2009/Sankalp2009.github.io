...
import { SiChakraui, SiExpress, SiMongodb, SiRedux, SiCypress } from "react-icons/si";
import { FaGitAlt } from "react-icons/fa";
import "./Page.css";
function Skills(){
return <Box id="Skills" w="full" bg="#93857a" color="#ffffff" p="30px 0px" mt="-2px" pt="100px">
        <Box w="85%" m="auto">
            <Text color="Black" textAlign="center" mb="15px" fontWeight="400" fontSize={["3xl", "4xl", "5xl"]}>Technical Skills</Text>
